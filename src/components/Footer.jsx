  ...
  return (
    ...
    >
        <div className="absolute inset-0 bg-black/70 z-0 backdrop-blur-sm" />
            ...
            <div className="mt-10">
                <a href="https://wa.link/5rlt9m" target='_blank' className="inline-flex items-center px-6 py-4 bg-custom-red text-white font-bold text-lg rounded-xl transition-all hover:scale-105 active:scale-95 duration-500 gap-2 shadow-lg">
